...
export default function Contact() {
  return (
    <div className="w-screen h-40 flex items-center justify-evenly bg-gray-200">
      <div className="flex flex-col items-center md:m-2">
        <h3 className="text-center text-xl">Check my profile at:</h3>
        <a
          className="my-2 w-16 h-16 rounded-xl bg-gray-100"
      ...
      <div className="flex flex-col items-center m-2">
        <h3 className="text-center text-xl">Contact me:</h3>
        <a
          className="my-2 w-16 h-16 rounded-xl bg-gray-100"
      ...
      <div className="flex flex-col items-center m-2">
        <h3 className="text-center text-xl">Download my resume:</h3>
        <a className="my-2 w-16 h-16 rounded-xl bg-gray-100" href={PDF}>
